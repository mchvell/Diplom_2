...
class TestCreateUser:
    ...
    @allure.description("Создаем нового юзера со случайными данными")
    ...
    @allure.description("Создаем нового юзера с существующими данными")
    ...
    @allure.description("Создаем нового юзера с пустой строкой имя")
